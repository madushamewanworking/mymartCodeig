...
<!--									<a id="nav_des_acc" href="--><?php //echo base_url(); ?><!--index.php/accountcontroller" rel="external" data-role="button" rel=external class="ui-btn-right ui-btn ui-icon-user ui-btn-icon-notext ui-corner-all" >ACCOUNT</a>-->
        ...
        <div role="main" class="ui-content">
            <ul data-role="listview" data-inset="true" class="home-cat-list">
                ...
                <li>
					<a href="<?php echo site_url('/maincontroller/productbycategory/'. $cat->getCatId()); ?>" data-ajax="false" >
...
<!--						</a>-->
				...
				<?php endforeach;  ?>
<!--                <li><a href="#">-->
<!--                        <img src="--><?php //echo base_url(); ?><!--assets/images/res/offer.jpg" class="ui-li-thumb">-->
<!--                        <h2>BlackBerry 10</h2>-->
